...
user_pres = User.create(email: "mat.diet@lewagon.fr", password: "123456", username: "Mateo")
...
pierro = Stone.create(name:'Pierre Roulée Aventurine', description: 'L’aventurine est connue pour libérer l’esprit.', price: 14.99, user: user, image:"https://static.wixstatic.com/media/101e87_1f909a1388554cbcb9ba18e588fe3024~mv2.jpg/v1/fill/w_1000,h_750,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/101e87_1f909a1388554cbcb9ba18e588fe3024~mv2.jpg")
...
Booking.create(status: "pending", start_date: "8 Jun. 23", end_date: "13 Jun. 23", comment: "J'en rêve depuis petit !", user: user, stone: caillou )
Booking.create(status: "accept", start_date: "1 Jun. 23", end_date: "5 Jun. 23", comment: "", user: user_pres, stone: pierro)
