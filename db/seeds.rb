...
Stone.create(name:'Pierre Roulée Sodalite', description: 'La sodalite est la pierre de l’épanouissement et du développement personnel', price: 4.99, user: user, image: "https://www.pierreetenergie.fr/product-page/pierre-roulee-sodalite")
