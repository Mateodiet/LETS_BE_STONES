...
Booking.create(status: "pending", start_date: "8 Jun. 23", end_date: "13 Jun. 23", comment: "J'en rêve depuis petit !", user: user, stone: pierre )
Booking.create(status: "accept", start_date: "1 Jun. 23", end_date: "5 Jun. 23", comment: "", user: pres_user, stone: caillou)
